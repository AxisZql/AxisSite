...
try {
    ...
    $(function() {
        ...
        console.log("%c AxisZql %c", "background:#24272A; color:#ffffff", "", "https://axiszql.top/");
        console.log("%c Github %c", "background:#24272A; color:#ffffff", "", "https://github.com/axiszql");
    });
